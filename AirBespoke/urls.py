...
urlpatterns += [
    ...
    # Custom URLs
    url("^tailors/", include("tailors.urls", namespace="tailors")),
    url("^fabrics/", include("fabrics.urls", namespace="fabrics")),
    url("^login/", login_view, name='login'),
    url("^logout/", logout_view, name='logout'),
    url("^register/", register_view, name='register'),

    # url("^custom_product/(?P<slug>[\w-]+)/$",ProductDetailView.as_view(), name = 'product_detail_slug_view'),
